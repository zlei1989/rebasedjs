/**
 * 历史快照浏览页容器：?rev= 查询串（入口通道）+ 页内 ref 输入 → useBrowseTree + useBrowseContent
 * → ui BrowsePanel（与 web-next 容器同构；repoId 取 useParams、返回导航用 useNavigate）。
...
export function RepoBrowsePage(): React.ReactNode {
