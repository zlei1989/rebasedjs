...
export { cloneGitRepo, findRepoRoot, initGitRepo, readHeadBranch } from './repo';
...
export { commitFiles } from './committed';
...
export { addRemote, checkoutWithUpdate, defaultRemoteName, fetchRemote, isShallowRepo, listLocalOnlyCommits, listRemotes, pullRemote, pushBranch, pushUpToCommit, removeRemote, setRemoteUrl } from './remote';
