...
| 导航边缺口 | 14 条 ❌ 可做 + 2 条 🟡 直达（#13 LogPage→DiffPage、#21 右键动作直通）；4 条 ❌ 明确不做另列 | §2.4 |
...
### 2.4 P3：导航边缺口（14 条可做 + 2 条 🟡 直达，按目标页分组）
